...
- Before style approval, create at most one representative image, a short fictional-voice audition, and one 3–5 second proof when motion is new or coupled topology is present. A topology proof uses the actual v4 group, master-derived members, and renderer.
