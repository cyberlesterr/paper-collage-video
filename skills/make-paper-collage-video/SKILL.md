...
description: Create and resume configuration-driven layered paper-collage videos in this Remotion repository, from a topic or brief through script, storyboard, image layers, fictional narration, preview review, final render, and technical acceptance. Use when Codex is asked to make, reproduce, continue, revise, or productize a paper-cutout, historical collage, layered illustration, or parallax explainer video with human approval gates.
---
